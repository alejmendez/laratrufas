...
use Modules\Field\Http\Requests\StoreSecurityEquipmentRequest;
use Modules\Field\Http\Requests\UpdateSecurityEquipmentRequest;
use Modules\Field\Http\Resources\SecurityEquipmentResource;
use Modules\Field\Services\SecurityEquipments\CreateSecurityEquipment;
use Modules\Field\Services\SecurityEquipments\DeleteSecurityEquipment;
use Modules\Field\Services\SecurityEquipments\FindSecurityEquipment;
use Modules\Field\Services\SecurityEquipments\ListSecurityEquipment;
use Modules\Field\Services\SecurityEquipments\UpdateSecurityEquipment;
use Inertia\Inertia;
