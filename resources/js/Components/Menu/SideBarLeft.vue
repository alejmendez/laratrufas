...
const menuData = [
  {
    ...
    children: [
      ...
      { link: route('quarters.index'), text: t('menu.quarters'), icon: 'fa-solid fa-table-cells-large', active: page.component.startsWith('Quarter') },
  ...
  },
  {
    ...
    children: [
      ...
      { link: route('bulk.index'), text: t('menu.bulk_uploads'), icon: 'fa-solid fa-file-arrow-up', active: page.component.startsWith('Bulk') },
    ],
  },
];
